...
if (localStorage.getItem("fadcharge") !== null) {
  document.getElementById("foradult").innerText = "$" + localStorage.getItem("fadcharge");
  fadult_guest = parseInt(localStorage.getItem("adultF"));
  fadult = parseInt(localStorage.getItem("fadcharge"));
